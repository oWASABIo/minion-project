declare global {
  const template_SPECS: typeof import("../../server/utils/template-spec.ts").template_SPECS;
  const STACK_SPECS: typeof import("../../server/utils/stack-spec.ts").STACK_SPECS;
  const TEMPLATE_REGISTRY: typeof import("../../server/utils/template-registry.ts").TEMPLATE_REGISTRY;
  ...
  const buildMockConfigFromTemplate: typeof import("../../server/utils/mock-page-config.ts").buildMockConfigFromTemplate;
  const buildMockPageConfig: typeof import("../../server/utils/mock-page.ts").buildMockPageConfig;
  const buildMockProject: typeof import("../../server/utils/mock-page.ts").buildMockProject;
  ...
  const enforceStackConstraints: typeof import("../../server/utils/stack-spec.ts").enforceStackConstraints;
  ...
  const generateContentWithRetry: typeof import("../../server/utils/gemini.ts").generateContentWithRetry;
  const generateProjectFiles: typeof import("../../server/utils/scaffold.ts").generateProjectFiles;
  ...
  const gettemplateSpec: typeof import("../../server/utils/template-spec.ts").gettemplateSpec;
  ...
  const getRandomTemplate: typeof import("../../server/utils/template-registry.ts").getRandomTemplate;
  ...
  const getStackSpec: typeof import("../../server/utils/stack-spec.ts").getStackSpec;
  ...
  const hashString: typeof import("../../server/utils/mock-page.ts").hashString;
  ...
  const normalizePageConfig: typeof import("../../server/utils/normalize-page-config.ts").normalizePageConfig;
  const parseCookies: typeof import("../../node_modules/h3/dist/index.mjs").parseCookies;
  const parsePromptPattern: typeof import("../../server/utils/prompt-pattern.ts").parsePromptPattern;
  ...
  const resolveWordpressConfig: typeof import("../../server/utils/backend.ts").resolveWordpressConfig;
  ...
  const useGemini: typeof import("../../server/utils/gemini.ts").useGemini;
...
declare global {
  ...
  export type {
    Pagetemplate,
    templateSpec,
  } from "../../server/utils/template-spec.ts";
  import("../../server/utils/template-spec.ts");
  // @ts-ignore
  export type { PromptDirectives } from "../../server/utils/prompt-pattern.ts";
  import("../../server/utils/prompt-pattern.ts");
  // @ts-ignore
  export type { StackSpec } from "../../server/utils/stack-spec.ts";
  import("../../server/utils/stack-spec.ts");
}
...
} from "/Users/jeddirok.k/Documents/ai-landing-nuxt/node_modules/@nuxt/nitro-server/dist/runtime/utils/paths";
export { defineAppConfig } from "/Users/jeddirok.k/Documents/ai-landing-nuxt/node_modules/@nuxt/nitro-server/dist/runtime/utils/config";
export { resolveWordpressConfig } from "/Users/jeddirok.k/Documents/ai-landing-nuxt/server/utils/backend";
export {
  useGemini,
  generateContentWithRetry,
} from "/Users/jeddirok.k/Documents/ai-landing-nuxt/server/utils/gemini";
export {
  template_SPECS,
  gettemplateSpec,
} from "/Users/jeddirok.k/Documents/ai-landing-nuxt/server/utils/template-spec";
export { buildMockConfigFromTemplate } from "/Users/jeddirok.k/Documents/ai-landing-nuxt/server/utils/mock-page-config";
export {
  hashString,
  buildMockProject,
  buildMockPageConfig,
} from "/Users/jeddirok.k/Documents/ai-landing-nuxt/server/utils/mock-page";
export { normalizePageConfig } from "/Users/jeddirok.k/Documents/ai-landing-nuxt/server/utils/normalize-page-config";
export { parsePromptPattern } from "/Users/jeddirok.k/Documents/ai-landing-nuxt/server/utils/prompt-pattern";
export { generateProjectFiles } from "/Users/jeddirok.k/Documents/ai-landing-nuxt/server/utils/scaffold";
export {
  STACK_SPECS,
  getStackSpec,
  enforceStackConstraints,
} from "/Users/jeddirok.k/Documents/ai-landing-nuxt/server/utils/stack-spec";
export {
  TEMPLATE_REGISTRY,
  getRandomTemplate,
} from "/Users/jeddirok.k/Documents/ai-landing-nuxt/server/utils/template-registry";
