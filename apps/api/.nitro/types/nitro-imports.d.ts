declare global {
  ...
  const buildMockConfigFromTemplate: typeof import('../../server/utils/mock-page-config').buildMockConfigFromTemplate
...
export { buildMockConfigFromTemplate } from '/Users/jeddirok.k/Documents/minions/apps/api/server/utils/mock-page-config';